                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/nlrijk/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                        <label for="fieldzkdwi" class="visuallyhidden">First Name</label>
        ...
        return Vue.component("newsletter-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/pleasanthill-newsletter.json"}), this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
