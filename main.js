require.config({
    paths: {
        ...
        'bugsnag-plugin-vue': 'https://mmvue.codecloudapp.com/bugsnag-vue',
        'image_popup':'https://mmvue.codecloudapp.com/image_popup.vue?noext',
    }
});

require(['Vue', 'vuex', 'vue2-filters', 'vue_router', 'routes', 'vuex-router-sync', 'datastore', 'vue-i18n', 'locales', 'moment', 'vue-meta', 'vue-breadcrumbs', 'vue!loading.vue', 'vue!messages.vue', 'vue!header.vue', 'vue!footer.vue', 'vue!inside_header.vue', 'vue!breadcrumb.vue','bugsnag', 'bugsnag-plugin-vue'], function (Vue, Vuex, Vue2Filters, VueRouter, appRoutes, VuexRouterSync, store, VueI18n, messages, moment, Meta, VueBreadcrumbs, LoadingComponent, MessagesComponent, HeaderComponent, FooterComponent, insideHeaderComponent, BreadcrumbComponent, bugsnag, bugsnagVue) {
