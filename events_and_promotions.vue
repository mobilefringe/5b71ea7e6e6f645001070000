                            ...
                            <div v-if="promos.length >= 1" v-for="item in promos" :key="item.id">
                                <div class="row event_container">
                                    ...
                                    <div class="col-sm-6 col-md-8">
                                        ...
                                        <p class="event_dates">
                                            <span v-if="isMultiDay(item)">{{ item.start_date | moment("MMMM D", timezone)}} - {{ item.end_date | moment("MMMM D", timezone)}}</span>
            ...
            computed: {
                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1542645885036/dtph_events.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1542645885036/dtph_events.png";
                            }
                ...
                promoList: function promos() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1542645869115/dtph_promos.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1542645869115/dtph_promos.png";
                            }
