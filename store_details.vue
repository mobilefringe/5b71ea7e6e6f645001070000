        ...
        return Vue.component("store-details-component", {
            ...
            watch: {
                ...
                currentStore: function () {
                    ...
                    //     this.currentStore.store_front_url_abs = "//codecloud.cdn.speedyrails.net/sites/5d8b7f8a6e6f647c040d0000/image/png/1534974105000/dtph_default.png"
                    // }
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5d8b7f8a6e6f647c040d0000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5d8b7f8a6e6f647c040d0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
