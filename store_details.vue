        ...
        return Vue.component("store-details-component", {
            ...
            created (){
                this.loadData().then(response => {
                    ...
                    // } else {
                    //     this.pageBanner = {
                    //         "image_url": "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/jpeg/1529532304000/insidebanner2.jpg"
                    //     }
                    // }
            ...
            watch: {
                ...
                currentStore: function () {
                    ...
                    //     this.currentStore.store_front_url_abs = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1534974105000/dtph_default.png"
                    // }
                    ...
                    if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                        ...
                        if (_.includes(subcategories, 8257)) {
                            this.hasUberEats = true;
                        }
                        if (_.includes(subcategories, 8253)) {
                            this.hasDoordash = true;
                        }
                        if (_.includes(subcategories, 8254)) {
                            this.hasGrubhub = true;
                        }
                        if (_.includes(subcategories, 8255)) {
                            this.hasPostmates = true;   
                        }
                        if (_.includes(subcategories, 8256)) {
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5de184076e6f6416c44a0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
